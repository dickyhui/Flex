package com.esri.viewer
{
	...
	public class GoogleAerial extends ArcGISTiledMapServiceLayer
	{
		private var _tileInfo:TileInfo=new TileInfo();
		private var _baseURL:String="http://mt0.google.cn/vt/lyrs=s@88&hl=zh-CN&gl=cn&x=";
		
		public function GoogleAerial()
		{
			super();
			buildTileInfo();
			setLoaded(true);
		...
		{
			var url:String=_baseURL + col.toString() + "&y=" + row.toString() + "&z=" + level.toString() + "&s=Galileo";
