...
public class AppEvent extends Event
{
     ...
     *
     * <listing>
     * ViewerContainer.dispatchEvent(new AppEvent(AppEvent.APP_ERROR, false, false, "An Error Message"));
     * </listing>
     *
     ...
     *       status: status
     *      }
     *   ViewerContainer.dispatchEvent(new AppEvent(AppEvent.SET_MAP_NAVIGATION, false, false, data));
     * </listing>
     *
     */
     ...
     *
     * <listing>
     *  ViewerContainer.dispatchEvent(new AppEvent(AppEvent.SHOW_INFOWINDOW, false, false, infoData));
     * </listing>
     *
     ...
     *
     * <listing>
     * ViewerContainer.dispatchEvent(new AppEvent(AppEvent.SET_MAP_ACTION, false, false, data));
     * </listing>
     *
	...
	public static const CHANGE_WIDGET_STATE:String = "changewidgetstate";
	
	//自定义事件
	//用于ResetWidget关闭WaveAnimationWidget
	public static const CloseWaveAnimation:String = "CloseWaveAnimation";
	public static const CloseWave:String = "CloseWave";
	public static const CloseWind:String = "CloseWind";
	public static const CloseCurrent:String = "CloseCurrent";
	public static const AlertValuesSubmit:String = "AlertValuesSubmit";
