...
/**
 * ZfybdId generated by hbm2java
 */
public class ZfybdId implements java.io.Serializable {
	...
	public ZfybdId(String year, String month, String day, String filename,
			String hour) {
		this.year = year;
		this.month = month;
		this.day = day;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ZfybdId))
			return false;
		ZfybdId castOther = (ZfybdId) other;
