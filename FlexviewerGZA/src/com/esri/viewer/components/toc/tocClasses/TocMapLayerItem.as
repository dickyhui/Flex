...
public class TocMapLayerItem extends TocItem
{
    ...
    private function createChildren():void
    {
        ...
        if (layerInfos)
        {
            ...
            {
				var toclayer:TocLayerInfoItem;
				if((toclayer = createTocLayer(this, layerInfo, layerInfos, visibleLayers)) != null )
                	addChild(toclayer);
            }
        }
    }
    ...
    private static function createTocLayer(parentItem:TocItem, layerInfo:LayerInfo, layerInfos:Array, visibleLayers:Array):TocLayerInfoItem
    {
		...
		for each(var layerID:String in visibleLayers)
		{
			if(layerInfo.id.toString() == layerID)
			{
				visible = true;
				break;
			}
