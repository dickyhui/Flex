...
public class AppEvent extends Event
{
	...
	//widget下载完成(preInitial)
	public static const WIDGETDOWNLOADCOMPLETE:String = "widgetDownloadComplete";
	
	//切换功能面板视图
	public static const CHANGEPRODUCTVIEW:String = "changeProductView";
	
	//加载中的动画
	public static const LOADING:String = "loading";
	
	//productwidget配置文件加载完毕
	public static const PRODUCTCONFIGLOADED:String = "productWidgetConfigLoaded";
