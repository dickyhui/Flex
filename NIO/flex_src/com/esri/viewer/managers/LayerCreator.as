...
public class LayerCreator
{
    ...
    private static function createLayer(layerCreationProperties:LayerCreationProperties):Layer
    {
		...
		else if (layerType == "customtiled")
		{
			return createCustomTiledLayer(layerCreationProperties);
		}
        else
        {
	...
	//谷歌底图
	private static function createCustomTiledLayer(layerCreationProperties:LayerCreationProperties):ArcGISTiledMapServiceLayer
	{
		var tiledLayer:ArcGISTiledMapServiceLayer = new CustomTiledLayer(layerCreationProperties.url);
		tiledLayer.alpha = layerCreationProperties.alpha;
		tiledLayer.id = layerCreationProperties.label;
		tiledLayer.name = layerCreationProperties.label;
		tiledLayer.token = layerCreationProperties.token;
