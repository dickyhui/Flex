package com.esri.viewer
{
	...
	public class GoogleAnnotation extends ArcGISTiledMapServiceLayer
	{
		private var _tileInfo:TileInfo=new TileInfo();
		private var _baseURL:String="http://mt0.google.cn/vt/imgtp=png32&lyrs=h@157000000&hl=zh-CN&gl=cn";
		
		public function GoogleAnnotation()
		{
			super();
			buildTileInfo();
			setLoaded(true);
		...
		{
			var url:String=_baseURL +"&x="+ col.toString() + "&y=" + row.toString() + "&z=" + level.toString() + "&s=Galileo";
