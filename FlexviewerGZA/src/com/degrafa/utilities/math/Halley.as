//
// Halley.as - Compute simple roots of the equation f(x) = 0 given a starting point and convergence criteria, using
// Halley's method.  To use, set the iteration limit and tolerance, then call the findRoot method.
//
...
*/
    public function findRoot( _start:Number, _function:Function, _deriv:Function, _secondDeriv:Function ):Number   
    {
      ...
      // tbd - modify stopping criteria to use relative error
      __iter               = 1;
